  ...
  const renderStepContent = () => {
    switch (currentStep) {
      case 1:
        return (
          <div>
            <h3 className="text-info mb-3">I want to take a quiz on :</h3>
            <select
              className="form-select  bg-info-subtle"
      ...
      case 3:
        return (
          <div>
            <h2 className="text-info mb-2">Confirmation</h2>
            <h5>Subject: {selectedSubject}</h5>
            <h6 className="">Number of Questions: {selectedNumQuestions}</h6>
          </div>
        );
      default:
        return null;
